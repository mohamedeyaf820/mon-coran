...
const r = await page.evaluate(() => {
  ...
  const i0=l.querySelector('.tajweed-legend__intro'); const cs=getComputedStyle(i0);
  return { tag:i0.tagName, h:+i0.getBoundingClientRect().height.toFixed(1), minH:cs.minHeight, h2:cs.height, pad:cs.padding, lh:cs.lineHeight, fs:cs.fontSize, disp:cs.display };
});
