...
const OUT = ".scratch-diag/captures/clip36";
...
const fontIds = ["scheherazade-new","amiri-quran","noto-naskh-arabic"];
await page.locator(".reader-typography-panel .afc-range").fill("36");
