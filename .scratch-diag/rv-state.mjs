...
await ctx.addInitScript(() => {
  localStorage.setItem("mushaf-plus-settings", JSON.stringify({ skipSplashAnimation: true, showHome: true, sidebarOpen: false, homeSection: "surah", riwaya: "hafs", fontFamily: "qpc-hafs", lang: "fr", theme: "light" }));
  localStorage.setItem("mushaf-plus-onboarded", "1");
});
const p = await ctx.newPage();
await p.goto(BASE + "/surah/2", { waitUntil: "domcontentloaded", timeout: 60000 });
