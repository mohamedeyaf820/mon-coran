...
await shot({ riwaya: "hafs", page: 22, label: "hafs-22-juz2" });
await shot({ riwaya: "hafs", page: 582, label: "hafs-582-juz30" });
await shot({ riwaya: "warsh", page: 22, label: "warsh-22-juz2" });
await shot({ riwaya: "hafs", page: 23, label: "hafs-23-control" });
await browser.close();
