...
- Complément sur les dimensions : les deux feuilles partagent une largeur et une hauteur communes, avec un format portrait d'au moins 1:1,45 et un agrandissement commun si le contenu l'exige. Marges internes de 24 px avant zoom, bordure papier discrète, pied de page repoussé au bas de chaque feuille. Les hauteurs intrinsèques du contenu sont mesurées séparément du cadre pour éviter les boucles de mesure. Les pages d'ouverture ne raccourcissent plus leur feuille en fonction du nombre de versets. La largeur du texte est plafonnée à 16,7 em : les lignes sont recomposées pour le portrait, puis restent stables au zoom. Ce rendu utilise le même texte et le même renderer ; ce n'est pas un fac-similé éditorial à quinze lignes fixes.
