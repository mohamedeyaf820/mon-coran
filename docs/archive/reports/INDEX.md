> Archive historique : décrit un état antérieur du projet. Pour les instructions actuelles, consulter le [README](../../../README.md) et le [guide de démarrage](../../../QUICK_START.md).
...
### 3️⃣ **Si tu veux des exemples de code** (20 min)
   → Lire: `IMPLEMENTATION_EXAMPLES.md` (référence historique indisponible)
...
3. **SEE EXAMPLES** → `IMPLEMENTATION_EXAMPLES.md` (référence historique indisponible) (20 min)
