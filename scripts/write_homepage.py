...
# -*- coding: utf-8 -*-
"""
Rewrites HomePage.jsx with clean UTF-8 and a QWB-inspired spacious design.
Run:  python scripts/write_homepage.py
"""

PATH = "e:/mon coran/src/components/HomePage.jsx"
...
# Check for BOM
bom = lines[0].startswith('\ufeff')
print(f"Ecrit: {len(lines)} lignes | BOM: {bom} | Premiere: {repr(lines[0][:40])}")
