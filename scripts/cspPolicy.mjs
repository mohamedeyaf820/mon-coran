export function buildCspPolicy(mode = "production") {
  ...
  return [
    ...
    "font-src 'self' https://fonts.gstatic.com https://fonts.quranwbw.com https://verses.quran.foundation https://quran.com https://*.quran.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com data:",
