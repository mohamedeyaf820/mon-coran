export default {
  ...
  duas: {
    ...
    title: 'Supplications from the Quran and Sunnah',
    eyebrow: 'Spiritual library',
    subtitle: 'Find a supplication, read its vocalized Arabic, and keep its meaning close at hand.',
    back: 'Home',
    search: 'Search: waking, protection, travel…',
    clearSearch: 'Clear search',
    collection: 'All supplications',
    collectionCopy: 'Identified sources, calm reading, and discreet actions.',
    noResults: 'No supplication matches your search.',
    noResultsHint: 'Try another word or return to all categories.',
    resetFilters: 'Reset filters',
    resultCount: { zero: '{count} supplications', one: '{count} supplication', two: '{count} supplications', few: '{count} supplications', many: '{count} supplications', other: '{count} supplications' },
    totalCount: { zero: '{count} texts available', one: '{count} text available', two: '{count} texts available', few: '{count} texts available', many: '{count} texts available', other: '{count} texts available' },
    copy: 'Copy supplication',
    copied: 'Supplication copied',
    copyError: 'Unable to copy the supplication.',
    openQuran: 'Read in the Quran',
    quranSource: 'Quran',
    sunnahSource: 'Hisn al-Muslim',
    categories: {
      all: 'All', daily: 'Daily', protection: 'Protection', ibadah: 'Worship',
      tawhid: 'Tawhid', hidayah: 'Guidance', forgiveness: 'Forgiveness', steadfastness: 'Steadfastness',
      family: 'Family', 'dunya-akhirah': 'Dunya & Akhirah', ummah: 'Ummah', rizq: 'Provision',
      shifa: 'Healing', safar: 'Travel',
    },
  },
  sidebar: {
