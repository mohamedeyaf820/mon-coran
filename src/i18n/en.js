export default {
  ...
  export: {
    ...
    qrPrivacy: "This link and QR are not encrypted. Anyone receiving them can read the shared data.",
    qrIncludeNotes: "Include my private notes",
    qrTooLarge: "QR unavailable: share less data or use the link when available.",
    qrSync: 'QR Sync (P2P)',
    qrDesc: 'Transfer your bookmarks, notes and reading progress to your phone without any account or cloud.',
    qrGenerate: 'Generate QR Code',
    qrScan: 'Scan or Import',
    qrCopyLink: 'Copy direct link',
    qrDownload: 'Download QR Code',
    qrScanPrompt: 'Scan this QR Code with your smartphone camera to sync instantly.',
    qrImportTitle: 'Paste or Import',
    qrImportPlaceholder: 'Paste the sync link or code here...',
    qrApply: 'Import data',
    qrSuccess: 'Sync successful!',
    qrInvalid: 'Invalid sync code',
    qrDetectPrompt: 'Sync data detected. Do you want to import your bookmarks, notes and reading progress?',
  },
  errors: {
