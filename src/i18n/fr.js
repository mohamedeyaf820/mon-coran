export default {
  ...
  export: {
    ...
    qrPrivacy: "Ce lien et ce QR ne sont pas chiffrés. Toute personne qui les reçoit peut lire les données partagées.",
    qrIncludeNotes: "Inclure mes notes privées",
    qrTooLarge: "QR indisponible : réduisez les données partagées ou utilisez le lien lorsqu’il est disponible.",
    qrSync: 'Synchronisation QR (P2P)',
    qrDesc: 'Transférez vos favoris, notes et progression vers votre téléphone sans compte ni cloud.',
    qrGenerate: 'Générer le QR Code',
    qrScan: 'Scanner ou Importer',
    qrCopyLink: 'Copier le lien direct',
    qrDownload: 'Télécharger le QR Code',
    qrScanPrompt: 'Scannez ce QR Code avec l\'appareil photo de votre smartphone pour synchroniser instantanément.',
    qrImportTitle: 'Coller ou Importer',
    qrImportPlaceholder: 'Collez le lien ou le code de synchronisation ici...',
    qrApply: 'Importer les données',
    qrSuccess: 'Synchronisation réussie !',
    qrInvalid: 'Code de synchronisation invalide',
    qrDetectPrompt: 'Données de synchronisation détectées. Voulez-vous importer vos favoris, notes et progression de lecture ?',
  },
  errors: {
