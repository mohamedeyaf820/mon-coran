export default {
  ...
  duas: {
    ...
    eyebrow: 'مكتبة إيمانية',
    subtitle: 'ابحث عن الدعاء، واقرأ نصه العربي المشكول ومعناه بوضوح وطمأنينة.',
    back: 'الرئيسية',
    search: 'ابحث: الاستيقاظ، الحفظ، السفر…',
    clearSearch: 'مسح البحث',
    collection: 'جميع الأدعية',
    collectionCopy: 'مصادر موثقة، وقراءة هادئة، وخيارات لا تشتت عن الدعاء.',
    noResults: 'لا يوجد دعاء يطابق بحثك.',
    noResultsHint: 'جرّب كلمة أخرى أو اعرض جميع الفئات.',
    resetFilters: 'إعادة ضبط عوامل التصفية',
    resultCount: { zero: 'لا توجد أدعية', one: 'دعاء واحد', two: 'دعاءان', few: '{count} أدعية', many: '{count} دعاءً', other: '{count} دعاء' },
    totalCount: { zero: 'لا توجد نصوص', one: 'نص واحد متاح', two: 'نصان متاحان', few: '{count} نصوص متاحة', many: '{count} نصًا متاحًا', other: '{count} نص متاح' },
    copy: 'نسخ الدعاء',
    copied: 'تم نسخ الدعاء',
    copyError: 'تعذر نسخ الدعاء.',
    openQuran: 'اقرأ في المصحف',
    quranSource: 'القرآن',
    sunnahSource: 'حصن المسلم',
    categories: {
      all: 'الكل', daily: 'أذكار اليوم', protection: 'التحصين', ibadah: 'العبادة',
      tawhid: 'التوحيد', hidayah: 'الهداية', forgiveness: 'المغفرة', steadfastness: 'الثبات',
      family: 'الأسرة', 'dunya-akhirah': 'الدنيا والآخرة', ummah: 'الأمة', rizq: 'الرزق',
      shifa: 'الشفاء', safar: 'السفر',
    },
  },
  sidebar: {
