export default {
  ...
  settings: {
    ...
    wordByWordMode: 'وضع كلمة بكلمة', wordByWordDesc: 'إظهار الترجمة تحت كل كلمة',
  ...
  toast: {
    ...
    memorizationLevel: 'مستوى الحفظ {level}/5',
    memorizationReset: 'تمت إعادة مستوى الحفظ',
    ...
    repeatEnabled: 'تكرار الآية ×{count}',
    translationShown: 'تم إظهار الترجمة',
    textCopied: 'تم نسخ النص',
    shareTextCopied: 'تم نسخ نص المشاركة',
    studyModeEnabled: 'تم تفعيل وضع الدراسة',
    pinRemoved: 'تمت إزالة الآية من المقارنة',
    pinLimit: 'احتفظ بـ ٤ آيات كحد أقصى للمقارنة',
    pinAdded: 'تم تثبيت الآية للمقارنة',
