export default {
  ...
  export: {
    ...
    qrPrivacy: "هذا الرابط والرمز غير مشفرين. يمكن لأي شخص يستلمهما قراءة البيانات المشتركة.",
    qrIncludeNotes: "تضمين ملاحظاتي الخاصة",
    qrTooLarge: "الرمز غير متاح: قلل البيانات المشتركة أو استخدم الرابط إن كان متاحًا.",
    qrSync: 'المزامنة عبر رمز QR (مباشر)',
    qrDesc: 'انقل مفضلتك وملاحظاتك وموضع قراءتك إلى هاتفك بدون حساب أو خادم سحابي.',
    qrGenerate: 'إنشاء رمز QR',
    qrScan: 'مسح أو استيراد',
    qrCopyLink: 'نسخ الرابط المباشر',
    qrDownload: 'تحميل رمز QR',
    qrScanPrompt: 'امسح هذا الرمز بكاميرا هاتفك للمزامنة فوراً دون وسيط.',
    qrImportTitle: 'لصق أو استيراد',
    qrImportPlaceholder: 'الصق رابط المزامنة أو الرمز هنا...',
    qrApply: 'استيراد البيانات',
    qrSuccess: 'تمت المزامنة بنجاح!',
    qrInvalid: 'رمز المزامنة غير صالح',
    qrDetectPrompt: 'تم اكتشاف بيانات مزامنة. هل تريد استيراد المفضلة والملاحظات وموضع القراءة؟',
  },
  errors: {
