          ...
          >
            ...
            <div className="modal-header !border-b !border-[var(--border)] !bg-[var(--bg-secondary)] flex items-center justify-between !py-4 !px-5">
              <div className="modal-title-stack">
                ...
                >
                  <i
                    className="fas fa-shapes text-primary"
                    aria-hidden="true"
                  ></i>
                  {tr({
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {tools.map((tool) => (
                  ...
                  >
                    ...
                    >
                      <i
                        className={`fas ${tool.icon} text-lg`}
                        aria-hidden="true"
                      ></i>
                    </div>
                    ...
                    <h3 className="text-[0.95rem] font-bold text-text-primary mb-1.5 group-hover:text-primary transition-colors flex items-center gap-1.5 w-full">
                      ...
                      <i
                        className="fas fa-arrow-right text-[0.7rem] opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all ml-auto rtl:rotate-180"
                        aria-hidden="true"
                      ></i>
                    </h3>
