...
export default function SearchModal() {
  ...
  return (
    <div className="modal-overlay" onClick={close}>
      <div
        className="modal modal-panel--wide modal-search-panel"
      ...
      >
        ...
        <div className="modal-toolbar">
          ...
          {SpeechRecognition && (
            ...
            >
              <i
                className={`fas ${listening ? "fa-stop" : "fa-microphone"}`}
              ></i>
            </button>
          )}
          <button
        ...
        >
          <button
            className={`modal-segmented-btn ${searchMode === "arabic" ? "active" : ""}`}
          ...
          <button
            className={`modal-segmented-btn ${searchMode === "phonetic" ? "active" : ""}`}
          ...
          <button
            className={`modal-segmented-btn ${searchMode === "fr" ? "active" : ""}`}
            onClick={() => setSearchMode("fr")}
          >
            <i className="fas fa-language"></i> FR
          </button>
          <button
            className={`modal-segmented-btn ${searchMode === "en" ? "active" : ""}`}
          ...
          {!query && !loading && (
            <div className="search-spotlight">
              ...
              <div className="search-spotlight-body">
                <h3>
                  {lang === "fr"
                    ? "Rechercher dans le texte coranique"
                    : lang === "ar"
                      ? "ابحث داخل النص القرآني"
                      : "Search inside the Quran text"}
                </h3>
                <p>
                  {lang === "fr"
                ...
                <div className="modal-item-main">
                  <div className="search-result-head">
                    <div className="search-result-ref">
                      <span className="search-result-ref__ar">{s?.ar}</span>
                      <span className="search-result-ref__dot">·</span>
                      <span className="search-result-ref__name">
                        {surahTranslatedName}
                      </span>
