          ...
          ? (
              await Promise.all(
                playlist.ayahs.map(async (a) => {
                  const surahItems = await buildAudioPlaylistForSurah(
                    a.surah,
                    riwaya,
                  );
                  return (
                    surahItems.find((item) => item.numberInSurah === a.ayah) ||
                    null
                  );
                }),
              )
            ...
            <div className="modal-body modal-body--flush !max-h-[70vh] !overflow-auto !px-3 !pb-3 sm:!px-4 sm:!pb-4">
              {loading ? (
                ...
                <div className="panel-scroll">
                  <div className="panel-toolbar panel-toolbar--compact !mb-2 !flex !items-center !gap-2 !rounded-2xl !border !border-[var(--border)] !bg-white/[0.03] !p-2">
                    <input
                      type="text"
                      value={newName}
                            ...
                            style={
                              isActive
                                ? {
                                    ...
                                    boxShadow:
                                      "0 0 0 1px rgba(212,168,32,0.18)",
                                  }
                                : undefined
                            }
                          >
