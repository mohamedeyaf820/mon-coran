      ...
      >
        ...
        <div className="qc-header-meta relative z-[1] flex flex-col items-center gap-1.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[0.7rem] font-semibold text-[var(--text-muted)] border border-[var(--border)] hover:bg-[var(--bg-secondary)] hover:text-[var(--primary)] transition-colors font-[var(--font-ui)] mt-2"
            aria-label={
              lang === "fr"
          ...
          >
            ...
            {lang === "fr" ? "Info" : lang === "ar" ? "معلومات" : "Info"}
          </button>
        </div>
      </div>

      {/* Panneau d'information sourate */}
      {showInfo && (
        <SurahInfoPanel
          surahNum={surahNum}
          lang={lang}
