export function getFlowFontClass(fontSize) {
  return "[font-size:var(--qd-reading-font-size,40px)]";
}
...
export function getFlowClassName(fontSize, riwaya, isQCF4) {
  ...
  return `cpv-flow${isQCF4 ? " qcf4-container" : ""} ${getFlowFontClass(fontSize)} relative z-10 rounded-2xl p-6 text-justify [text-justify:inter-word] [text-align-last:right] text-[var(--text-quran)] [direction:rtl] [font-family:var(--font-quran)] [font-feature-settings:"liga"_1,"calt"_1,"kern"_1,"mark"_1,"mkmk"_1,"ccmp"_1] [letter-spacing:0] [text-rendering:optimizeLegibility] [-webkit-font-smoothing:antialiased] max-[768px]:leading-[calc(var(--arabic-reading-line-height-mobile,2.22)+0.28)] max-[768px]:p-4 max-[480px]:[font-size:var(--qd-reading-font-size,40px)] max-[480px]:leading-[calc(var(--arabic-reading-line-height-mobile,2.22)+0.18)] max-[480px]:p-3 max-[360px]:leading-[calc(var(--arabic-reading-line-height-mobile,2.22)+0.12)] ${riwayaClass}`;
}
