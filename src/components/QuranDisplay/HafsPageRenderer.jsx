...
// The printed sheet is cut with per-page QCF glyph fonts; only the legacy
// Madani-page id (no longer in the menu, kept for saved preferences) asks for
// it. "QPC Uthmani Hafs" is the same Uthmanic face set
