...
export default function ReadingHistoryPanel() {
  ...
  const MONTH_NAME = new Date(currentYear, currentMonth).toLocaleDateString(
    lang,
              ...
              {loading ? (
                ...
                <div className="panel-calendar-shell">
                  ...
                  <div className="panel-calendar-grid">
                    {DAY_NAMES.map((d) => (
                      <div key={d} className="panel-calendar-head">
                        {d}
                      </div>
                    ))}
                          ...
                          >
                            ...
                            <div className="modal-item-side">
                              <button
                                ...
                                type="button"
                                onClick={() => goToSession(s.surah, s.ayahFrom)}
                                aria-label={
                                  lang === "fr"
                                    ? "Ouvrir la session"
                                    : "Open session"
